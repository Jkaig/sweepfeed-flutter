...
class _ErrorBoundaryState extends ConsumerState<ErrorBoundary> {
  ...
  void initState() {
    ...
    // Store the existing error handler to chain it
    final existingHandler = FlutterError.onError;

    // Set up error handling that chains with existing handler
    FlutterError.onError = (details) {
      _handleError(details.exception, details.stack);
      // Call existing handler if it exists (e.g., Crashlytics)
      existingHandler?.call(details);
    };
  }
