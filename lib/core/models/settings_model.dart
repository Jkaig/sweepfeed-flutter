...
class AppSettings {
  ...
  const AppSettings({
    ...
    this.maxNotificationsPerDay = 10.0,
  ...
  factory AppSettings.fromJson(Map<String, dynamic> json) => AppSettings(
        ...
        maxNotificationsPerDay:
            (json['maxNotificationsPerDay'] as num?)?.toDouble() ?? 10.0,
  ...
  final double maxNotificationsPerDay;
  ...
  String toString() => 'AppSettings(fontSize: $fontSize, compactMode: $compactMode, '
      ...
      'defaultView: $defaultView, vibrationEnabled: $vibrationEnabled, '
      'notificationSound: $notificationSound, maxNotificationsPerDay: $maxNotificationsPerDay, '
      'groupNotifications: $groupNotifications)';
}
