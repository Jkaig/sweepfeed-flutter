...
class CloudFunctionsService {
  ...
  Future<bool> incrementContestClicks(String contestId) async {
    try {
      ...
      logger.e('Error incrementing contest clicks', error: e);
      return false;
    }
  }
  ...
  Future<bool?> toggleContestLike(String contestId) async {
    try {
      ...
      logger.e('Error toggling contest like', error: e);
      return null;
    }
  }
  ...
  Future<bool?> toggleContestSave(String contestId) async {
    try {
      ...
      logger.e('Error toggling contest save', error: e);
      return null;
    }
  }
  ...
  Future<Map<String, dynamic>?> checkRateLimit(String action) async {
    try {
      ...
      logger.w('Rate limit error: ${e.code} - ${e.message}');
      ...
      logger.e('Error checking rate limit', error: e);
      return null;
    }
  }
}
