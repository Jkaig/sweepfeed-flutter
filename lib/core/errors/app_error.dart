...
class AppError implements Exception { // Additional context about where error occurred
  ...
  static String _getMessageFromError(error) {
  ...
  static ErrorCategory _getCategoryFromError(error) {
    final errorString = error.toString().toLowerCase();
  ...
  @override
  String toString() => 'AppError: {Message: $message, Category: $category, Context: $context, RawError: $rawError}';
}
...
class NetworkError extends AppError {
  const NetworkError(String message, {super.rawError, super.context})
      : super(
          message: message,
...
class AuthenticationError extends AppError {
  const AuthenticationError(String message, {super.rawError, super.context})
      : super(
          message: message,
...
class ValidationError extends AppError {
  const ValidationError(String message, {super.rawError, super.context})
      : super(
          message: message,
...
class PaymentError extends AppError {
  const PaymentError(String message, {super.rawError, super.context})
      : super(
          message: message,
...
class FirestoreError extends AppError {
  const FirestoreError(String message, {super.rawError, super.context})
      : super(
          message: message,
