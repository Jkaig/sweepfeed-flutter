...
class AppColors {
  ...
  static const textLight =
      Color(0xFFA8B2C8); // #a8b2c8 - Improved contrast (was #8892b0)
  static const textSecondary = Color(0xFFA8B2C8); // Alias for textLight
  ...
  // --- Effects & Overlays ---
  static final Color glassBackground = primaryMedium.withOpacity(0.7);
  static const Color shineColor = Color(0x33FFFFFF); // White with low opacity for shine
  static const Color overlayStart = Color(0x00000000); // Transparent
  static const Color overlayEnd = Color(0xCC000000); // Dark overlay
  ...
  static const card =
      primaryMedium; // Was 0xFF112240 -> Mapped to new primaryMedium
  static const cardBorder = primaryLight; // Border color for cards
  static const cardHighlight = Color(0xFF2A4A70); // Highlight color for shimmer
