...
enum ChallengeType {
  ...
  static ChallengeType fromString(String value) => ChallengeType.values.firstWhere(
...
enum ChallengeDifficulty {
  ...
  static ChallengeDifficulty fromString(String value) => ChallengeDifficulty.values.firstWhere(
