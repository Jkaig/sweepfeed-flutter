...
final userProfileProvider =
  ...
  return userService.getUserProfile(currentUser.uid);
});
...
class _UnifiedNotificationSettingsScreenState
        ...
        child: Column(
          children: [
            ...
            _buildNotificationToggle(
              'dailyDigest',
              'Daily Digest',
              "Summary of today's best contests",
              Icons.today,
              true,
              isPremium,
            ),
  ...
  Widget _buildSmsSettings() => Container(
        ...
        child: SwitchListTile(
          ...
          subtitle: Text(
            'Text message alerts for high-value contests',
            style: AppTextStyles.bodySmall.copyWith(color: AppColors.textLight),
          ),
          activeThumbColor: AppColors.brandCyan,
          contentPadding:
