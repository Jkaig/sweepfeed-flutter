...
class _HelpSupportScreenState extends ConsumerState<HelpSupportScreen> {
  ...
  final List<Map<String, String>> _faqs = [
    {
      'question': 'How do I enter a contests?',
      'answer':
          'Simply browse available contests on the home screen and tap "Enter" on any that interest you. Make sure to read the entry requirements and terms before entering.',
    },
    {
      'question': 'Are there any entry limits?',
      'answer':
          'Each contests has its own entry rules. Some allow one entry per person, while others may allow daily entries. Check the specific contests details for entry limits.',
    },
    {
    ...
    },
    {
      ...
      'answer':
          'Winners are notified via email and in-app notification. Check the specific contests for the winner announcement date. Make sure your notifications are enabled.',
    },
    {
      'question': 'Is SweepFeed free to use?',
      'answer':
          'Yes, SweepFeed is completely free to download and use. There are no hidden fees or charges for entering contests.',
    },
    {
    ...
    },
    {
      ...
      'answer':
          'While each entry has equal chances, you can enter more contests to increase your overall opportunities. Refer friends to earn bonus entries in some contests.',
    },
    {
                              ...
                              SizedBox(
                                ...
                                child: Container(
                                  ...
                                  child: ElevatedButton.icon(
                                    ...
                                    icon: _isSubmitting 
                                        ? const SizedBox(width: 18, height: 18, child: CircularProgressIndicator(strokeWidth: 2, color: AppColors.brandCyan))
