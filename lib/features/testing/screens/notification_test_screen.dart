...
class _NotificationTestScreenState
  ...
  Future<void> _testBasicNotifications() async {
    ...
    try {
      // Run comprehensive test which includes basic notifications
  ...
  Future<void> _testRichMedia() async {
    ...
    try {
      // Run comprehensive test which includes rich media
      await notificationTestService.runComprehensiveTest(_testUserId);
      setState(() {
  ...
  Future<void> _testInteractiveActions() async {
    ...
    try {
      // Run comprehensive test which includes interactive notifications
      await notificationTestService.runComprehensiveTest(_testUserId);
      setState(() {
  ...
  Future<void> _testLiveActivities() async {
    ...
    try {
      // Run comprehensive test which includes live activities
      await notificationTestService.runComprehensiveTest(_testUserId);
      setState(() {
  ...
  Future<void> _testGrouping() async {
    ...
    try {
      // Run comprehensive test which includes grouping
      await notificationTestService.runComprehensiveTest(_testUserId);
      setState(() {
  ...
  Future<void> _testConsentManagement() async {
    ...
    try {
      // Run comprehensive test which includes consent management
      await notificationTestService.runComprehensiveTest(_testUserId);
      setState(() {
