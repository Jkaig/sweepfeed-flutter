...
class _AnalyticsDashboardWidgetState
  ...
  String _getBasicPrice(WidgetRef ref) {
    ...
    if (plans.isEmpty) return '\$4.99/mo'; // Fallback price
    ...
    try {
      ...
      return basicPlan.price ?? '\$4.99/mo';
    } catch (e) {
      try {
        final basicPlan = plans.firstWhere(
  ...
  String _getPremiumPrice(WidgetRef ref) {
    ...
    if (plans.isEmpty) return '\$9.99/mo'; // Fallback price
    ...
    try {
      ...
      return premiumPlan.price ?? '\$9.99/mo';
    } catch (e) {
      try {
        final premiumPlan = plans.firstWhere(
