...
class TierComparisonCard extends ConsumerWidget {
  ...
  Widget _buildFeaturesList(BuildContext context) => Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
          'Features & Benefits',
        ...
        ...tier.features.map(_buildFeatureItem),
      ],
    );
...
class TierLimitsComparisonWidget extends ConsumerWidget {
  ...
  Widget _buildFeatureRow(
      String feature, String free, String basic, String premium,) => Padding(
  ...
  String _getBasicPrice(WidgetRef ref) {
    ...
    if (plans.isEmpty) return '\$4.99'; // Fallback price
  ...
  String _getPremiumPrice(WidgetRef ref) {
    ...
    if (plans.isEmpty) return '\$9.99'; // Fallback price
