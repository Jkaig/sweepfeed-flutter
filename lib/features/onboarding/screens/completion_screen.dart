              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Semantics(
                      label:
                          'Welcome bonus! You earned ${OnboardingConstants.welcomeBonusPoints} Dust Bunnies for completing onboarding!',
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            // Cute dust bunny celebrating!
                            Image.asset(
                              'assets/images/dustbunnies/dustbunny_celebrating.png',
                              width: 80,
                              height: 80,
                            )
                                .animate()
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                const DustBunnyIcon(size: 28),
                                const SizedBox(width: 8),
                                Text(
                                  '+${OnboardingConstants.welcomeBonusPoints} Dust Bunnies',
                            ...
                            Text(
                              'Use Dust Bunnies for bonus entries and exclusive prizes!',
