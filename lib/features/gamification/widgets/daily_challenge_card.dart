...
class DailyChallengeCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isDailyLogin = definition.type == ChallengeType.dailyLogin.value;
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: isDailyLogin
                  ...
                  : (isComplete ? AppColors.successGreen.withValues(alpha: 0.2) : AppColors.brandCyan.withValues(alpha: 0.1)),
              borderRadius: BorderRadius.circular(12),
            ),
            child: ChallengeType.fromString(definition.type).buildIcon(
              isDailyLogin 
                  ? AppColors.brandGold 
                    ...
                    if (isClaimed)
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            const DustBunnyIcon(size: 16),
                            const SizedBox(width: 4),
                            Text(
                              '+${definition.reward} DustBunnies',
