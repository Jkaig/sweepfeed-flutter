...
class EmailCategoryTab extends ConsumerWidget {
  const EmailCategoryTab({
    required this.category, required this.label, required this.icon, super.key,
...
class EmailCategoryTabBar extends StatelessWidget {
  const EmailCategoryTabBar({
    required this.selectedIndex, required this.onTabSelected, super.key,
    this.tabs = const [
...
class AnimatedTabIndicator extends StatelessWidget {
  const AnimatedTabIndicator({
    required this.selectedIndex, required this.tabCount, super.key,
...
class ScrollableEmailCategoryTabBar extends StatelessWidget {
  const ScrollableEmailCategoryTabBar({
    required this.selectedIndex, required this.onTabSelected, required this.tabs, super.key,
  });
...
class EmailFilterChip extends StatelessWidget {
  const EmailFilterChip({
    required this.label, required this.icon, required this.isSelected, required this.onTap, super.key,
    this.count,
  });
