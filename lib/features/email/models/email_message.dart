...
enum EmailCategory {
  ...
  /// Promotional emails advertising contests and contests.
  promo,

  /// Winner notification emails for successful contest entries.
  winner,

  /// Emails containing coupons or discount codes.
  coupon,
}
...
class EmailMessage {
  ...
  factory EmailMessage.fromFirestore(DocumentSnapshot doc) {
    ...
    return EmailMessage(
      ...
      contestsName: data['contestsName'],
  ...
  final String? contestsName; // Extracted contests name if applicable
  ...
  String get previewText {
    final cleanBody =
        body.replaceAll(RegExp('<[^>]*>'), ''); // Remove HTML tags
  ...
  EmailMessage copyWith({
    ...
    List<String>? tags,
      ...
      contestsName: contestsName ?? this.contestsName,
  ...
  @override
  String toString() => 'EmailMessage{id: $id, from: $from, subject: $subject, category: $category, isRead: $isRead}';
}
...
class EmailSettings {
  ...
  /// Create from Firestore document
  factory EmailSettings.fromFirestore(Map<String, dynamic> data) => EmailSettings(
      ...
      sweepFeedAddress: data['sweepFeedAddress'],
  ...
  Map<String, dynamic> toFirestore() => {
      ...
      'sweepFeedAddress': sweepFeedAddress,
