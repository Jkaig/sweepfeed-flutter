...
class EnhancedAuthService {
  ...
  Future<UserCredential?> signInWithApple() async {
    try {
      ...
      // Generate raw nonce for Apple and hash it for Firebase
      final rawNonce = _generateRawNonce();
      final hashedNonce = sha256.convert(utf8.encode(rawNonce)).toString();

      // Request credential - send sha256 hash to Apple
      ...
      // Create OAuth credential - Firebase needs the raw nonce to verify
  ...
  /// Generates a raw nonce (without hashing) for Apple Sign In
  /// This raw nonce is passed to Firebase's rawNonce parameter
