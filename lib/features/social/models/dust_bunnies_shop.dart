...
/// DustBunnies shop item for cosmetic purchases
@immutable
class ShopItem {
  const ShopItem({
    required this.id,
  ...
  final int price; // Price in DustBunnies
...
enum ShopItemType {
  ...
  String get displayName {
    switch (this) {
      case ShopItemType.avatarFrame: return 'Avatar Frame';
      case ShopItemType.badge: return 'Badge';
      case ShopItemType.background: return 'Background';
      case ShopItemType.theme: return 'Theme';
      case ShopItemType.title: return 'Title';
      case ShopItemType.emoji: return 'Emoji';
      case ShopItemType.animation: return 'Animation';
      case ShopItemType.sticker: return 'Sticker';
      case ShopItemType.powerUp: return 'Power-up';
      case ShopItemType.utility: return 'Utility';
    }
  }

  String get emojiIcon {
    switch (this) {
      case ShopItemType.avatarFrame: return '🖼️';
      case ShopItemType.badge: return '🏅';
      case ShopItemType.background: return '🎨';
      case ShopItemType.theme: return '🎭';
      case ShopItemType.title: return '📛';
      case ShopItemType.emoji: return '😊';
      case ShopItemType.animation: return '✨';
      case ShopItemType.sticker: return '🎯';
      case ShopItemType.powerUp: return '⚡';
      case ShopItemType.utility: return '🛠️';
    }
  }
}
...
/// User's DustBunnies wallet and transaction history
@immutable
class DustBunniesWallet {
  const DustBunniesWallet({
  ...
  factory DustBunniesWallet.fromJson(Map<String, dynamic> json) =>
      DustBunniesWallet(
        ...
        recentTransactions: (json['recentTransactions'] as List?)
                ?.map((tx) => DustBunniesTransaction.fromJson(tx))
                .toList() ??
            [],
      );
  final String userId;
  ...
  final List<DustBunniesTransaction> recentTransactions;
  ...
  DustBunniesWallet copyWith({
    String? userId,
    int? balance,
    int? totalEarned,
    int? totalSpent,
    List<DustBunniesTransaction>? recentTransactions,
  }) =>
      DustBunniesWallet(
...
/// Individual DustBunnies transaction
@immutable
class DustBunniesTransaction {
  const DustBunniesTransaction({
    required this.id,
    required this.type,
  ...
  factory DustBunniesTransaction.fromJson(Map<String, dynamic> json) =>
...
/// Types of DustBunnies transactions
