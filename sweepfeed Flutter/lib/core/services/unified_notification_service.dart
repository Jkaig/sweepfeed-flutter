...
/// Represents the type of notification being sent in the sweepstakes app.
enum NotificationType {
  /// Notification for a newly added sweepstakes or contest.
  newSweepstakes,

  /// Notification that a sweepstakes is ending soon.
  endingSoon,

  /// Notification for high-value sweepstakes worth entering.
  highValue,

  /// Notification that the user has won a sweepstakes.
  wins,

  /// Daily digest notification summarizing available sweepstakes.
  dailyDigest,

  /// Weekly roundup notification with sweepstakes highlights.
  weeklyRoundup,
...
/// email, SMS, quiet hours, and user preferences for the sweepstakes app.
