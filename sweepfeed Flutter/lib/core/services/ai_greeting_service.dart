...
class AIGreetingService {
        ...
        'messages': [
          {
            'role': 'system',
            'content':
                'You are a friendly, enthusiastic sweepstakes companion that creates personalized greetings. Keep greetings under 8 words, upbeat, and relevant to the user\'s sweepstakes journey.',
          },
          {
            'role': 'user',
            'content': prompt,
  ...
  String _buildPrompt(UserProfile user) {
    ...
    parts.add('Make it encouraging about winning sweepstakes.');
