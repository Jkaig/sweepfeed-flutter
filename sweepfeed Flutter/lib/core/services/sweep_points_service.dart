  ...
  Future<SweepPointsReward> awardSweepPoints({
    ...
    try {
      ...
      await _firestore.runTransaction((transaction) async {
        ...
        int currentSP = currentData['currentSP'] as int;
        int totalSP = currentData['totalSP'] as int;
        final int currentLevel = currentData['level'] as int;
        final double multiplier = currentData['multiplier'] as double;
