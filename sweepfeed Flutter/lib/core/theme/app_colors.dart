...
class AppColors {
  // --- New Core Palette (Dark Theme Focused) ---
  static const primaryDark = Color(0xFF0A192F);    // Deep navy, primary background
  static const primaryMedium = Color(0xFF112240);   // Dark slate blue, surface/card background
  static const primaryLight = Color(0xFF1F3A60);    // Lighter navy, borders/dividers

  static const accent = Color(0xFF64FFDA);         // Bright teal, primary accent
  static const accentGlow = Color(0xFF89FFE2);     // Lighter teal for glow effects

  static const textWhite = Color(0xFFE6F1FF);       // Primary text color
  static const textLight = Color(0xFF8892B0);       // Secondary text, icons
  static const textMuted = Color(0xFF4A5568);       // Hint text, disabled elements

  // --- Status Colors ---
  static const successGreen = Color(0xFF10B981);   // For success messages, icons
  static const warningOrange = Color(0xFFF59E0B);  // For warnings
  static const errorRed = Color(0xFFEF4444);       // For errors

  // --- Gradient ---
  static const LinearGradient primaryGradient = LinearGradient(
    colors: [accent, Color(0xFF42A5F5)], // accent to a lighter blue
  ...
  static const dtPrimaryDark = accent;       // Was 0xFF0060DB (Using accent as primary interaction color)
  ...
  static const primary = accent;             // Was 0xFF64FFDA (Tealish) -> Now maps to new accent
  // primaryLight, primaryDark from legacy are now conceptually covered by the new primaryDark, Medium, Light set
  
  static const secondary = primaryMedium;      // Was 0xFF112240 (Dark Blue) -> Mapped to new primaryMedium
  ...
  static const background = primaryDark;       // Was 0xFF030D19 -> Mapped to new primaryDark
  static const backgroundDark = primaryDark;   // Alias for clarity
  static const backgroundLight = primaryMedium; // Conceptual mapping for a lighter background variant

  static const surface = primaryMedium;        // Was 0xFF112240 -> Mapped to new primaryMedium
  static const card = primaryMedium;           // Was 0xFF112240 -> Mapped to new primaryMedium

  static const textPrimary = textWhite;        // Was 0xFFE6F1FF -> Mapped to new textWhite
  static const textSecondaryOld = textLight;   // Was 0xFF8892B0 -> Mapped to new textLight (renamed to avoid clash)
  static const textHintOld = textMuted;        // Was 0xFF8892B0 -> Mapped to new textMuted (renamed to avoid clash)
  
  static const border = primaryLight;          // Was 0xFF334155 -> Mapped to new primaryLight
  static const divider = primaryLight;         // Was 0xFF1F3A60 -> Mapped to new primaryLight
