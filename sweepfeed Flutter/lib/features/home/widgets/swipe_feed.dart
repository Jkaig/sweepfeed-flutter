...
import '../../contests/widgets/swipe_to_enter_card.dart';
...
class _SwipeFeedState extends ConsumerState<SwipeFeed>
  ...
  List<Map<String, dynamic>> _swipeContests = [];
  ...
  Future<List<Map<String, dynamic>>> _generateSwipeContests() async {
    ...
    for (var i = 0; i < contestTemplates.length; i++) {
      ...
      contest['id'] = 'swipe_contest_$i';
      contest['entryCount'] = 5000 + random.nextInt(15000);
      ...
      contest['swipeCompleted'] = false;
      contest['trending'] = random.nextBool();
      contest['timesSwiped'] = random.nextInt(3);
