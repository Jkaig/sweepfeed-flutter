...
import '../providers/sweepcoins_provider.dart';
...
class _SweepCoinsShopScreenState extends ConsumerState<SweepCoinsShopScreen>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.read(sweepCoinsShopProvider.notifier).fetchShopItems();
      ref.read(sweepCoinsWalletProvider.notifier).fetchWallet('current_user');
      ref
  ...
  Widget _buildShopContent(ShopItemType type) => Consumer(
        builder: (context, ref, child) {
          ...
          return RefreshIndicator(
            onRefresh: () async {
              ref.read(sweepCoinsShopProvider.notifier).refresh();
            },
  ...
  Future<void> _purchaseItem(ShopItem item) async {
    ...
    try {
      ...
      final success = await ref
          .read(sweepCoinsShopProvider.notifier)
