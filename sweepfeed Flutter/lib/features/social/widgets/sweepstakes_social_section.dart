...
class SweepstakesSocialSection extends StatefulWidget {
  const SweepstakesSocialSection({
    required this.sweepstakesId,
    super.key,
  });
  final String sweepstakesId;

  @override
  State<SweepstakesSocialSection> createState() =>
      _SweepstakesSocialSectionState();
}

class _SweepstakesSocialSectionState extends State<SweepstakesSocialSection>
  ...
  Widget _buildCommentsTab() => Column(
        children: [
          ...
          // Comments list
          Expanded(
            child: StreamBuilder<List<SweepstakesComment>>(
              stream: socialService.getComments(widget.sweepstakesId),
  ...
  Widget _buildCommentCard(SweepstakesComment comment) {
        ...
        children: [
          ...
          Expanded(
            child: StreamBuilder<List<ReferralCode>>(
              stream: socialService.getReferralCodes(widget.sweepstakesId),
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  return const Center(child: CircularProgressIndicator());
                }
  ...
  Future<void> _postComment() async {
    ...
    try {
      await socialService.postComment(
        sweepstakesId: widget.sweepstakesId,
