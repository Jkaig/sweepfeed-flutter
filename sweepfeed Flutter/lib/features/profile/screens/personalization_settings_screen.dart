          ...
          return StatefulBuilder(
            builder: (context, setState) => ListView(
              ...
              children: [
                ...
                const Text(
                  "These help us find sweepstakes you'll love. Add or remove interests at any time.",
                ...
                const Text(
                  "We won't show you sweepstakes from these categories. You can un-hide them anytime.",
                  style: TextStyle(color: Colors.grey),
                ),
                const SizedBox(height: 8),
