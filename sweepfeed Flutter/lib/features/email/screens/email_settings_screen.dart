...
class _EmailSettingsScreenState extends ConsumerState<EmailSettingsScreen> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Use this email address to receive sweepstakes notifications directly in your SweepFeed inbox. Forward your existing sweepstakes emails here to keep everything organized.',
  ...
  Widget _buildEmailManagementSettings() {
    return _buildSettingsSection(
  ...
  void _openSetupGuide() {
    // TODO: Open email setup guide
    _showInfoSnackBar('Email setup guide coming soon');
  }

  void _openSimpleLoginGuide() async {
  ...
  void _exportEmails() {
    ...
    _showInfoSnackBar('Email export feature coming soon');
  }

  void _showTroubleshooting() {
    // TODO: Show troubleshooting guide
    _showInfoSnackBar('Troubleshooting guide coming soon');
  }

  void _contactSupport() {
    // TODO: Open support contact
    _showInfoSnackBar('Support contact coming soon');
  }

  void _confirmBulkDelete(int days) async {
    ...
    if (confirmed == true) {
      // TODO: Implement bulk delete by age
      _showSuccessSnackBar('Old emails deleted successfully');
    }
  }

  void _confirmDeleteAllRead() async {
    final confirmed = await showDialog<bool>(
      context: context,
      builder: (context) => AlertDialog(
        backgroundColor: AppColors.primaryMedium,
    ...
    if (confirmed == true) {
      // TODO: Implement delete all read emails
      _showSuccessSnackBar('All read emails deleted successfully');
    }
  }
