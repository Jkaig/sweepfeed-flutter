...
class _NotificationPreferencesScreenState
  ...
  Future<void> _loadPreferences() async {
    ...
    setState(() {
      _preferences['new_sweepstakes'] =
          prefs.getBool('new_sweepstakes') ?? false;
  ...
  Future<void> _togglePreference(String key, bool value) async {
    ...
    try {
      ...
      debugPrint('Failed to manage subscription for $key: $e');
    }
  }
            ...
            children: [
              ...
              _buildNotificationSection(
                ...
                [
                  ...
                  _buildPreferenceTile(
                    'High Value Prizes',
                    'Get alerts for sweepstakes with valuable prizes',
                    'high_value',
              ...
              _buildNotificationSection(
                ...
                [
                  _buildPreferenceTile(
                    ...
                    'Get notified about recent sweepstakes winners',
