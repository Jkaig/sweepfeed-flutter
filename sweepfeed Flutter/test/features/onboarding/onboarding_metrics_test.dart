...
import '../../../lib/features/onboarding/screens/adaptive_onboarding_wrapper.dart';
...
void main() {
  group('OnboardingMetrics', () {
    ...
    test('should create metrics with custom values', () {
      ...
      final completionTime = startTime.add(Duration(minutes: 5));
      ...
      expect(metrics.duration, equals(Duration(minutes: 5)));
    ...
    test('should calculate duration correctly', () {
      ...
      expect(metrics.duration, equals(Duration(minutes: 3, seconds: 30)));
    });
    ...
    test('should calculate completion rate edge cases', () {
      // Zero total steps
      var metrics = const OnboardingMetrics(stepsCompleted: 5, totalSteps: 0);
      expect(metrics.completionRate, equals(0.0));
